    ...
    <div className="p-2.5 border">
      <div className="pht-text flex">
        ...
        <div className="post-text flex-1">
          <textarea
            ...
            className="text-xl w-full mt-2.5 text-gray-900 placeholder-gray-600 outline-none overflow-hidden resize-none"
          ></textarea>
        </div>
      </div>
      <div className="icons-tweet-btn ml-20 flex justify-between">
          ...
          {postIcons.map((icon) => (
            <button>
              <svg
                ...
                height="37"
                viewBox="0 0 24 24"
                className="fill-primary-base p-2 hover:bg-primary-light rounded-full duration-150"
              >
                <g>
        ...
        <button
          ...
          className="bg-primary-base hover:bg-primary-dark duration-200 text-white-mat font-bold px-4 rounded-full disabled:bg-primary-notAcLights"
          disabled={!textarea}
        >
          Tweet
        </button>
